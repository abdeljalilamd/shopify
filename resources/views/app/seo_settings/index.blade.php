<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            @lang('crud.seo_settings.index_title')
        </h2>
    </x-slot>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <a
                                            href="{{ route('seo-settings.edit', $seoSetting) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('view', $seoSetting)
                                        <a
                                            href="{{ route('seo-settings.show', $seoSetting) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('delete', $seoSetting)
                                        <form
                                            action="{{ route('seo-settings.destroy', $seoSetting) }}"
                                            method="POST"
